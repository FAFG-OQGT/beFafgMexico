...
const getDataReporte = (req, res, next) => {
  controller
    .getDataReporte(req)
    .then((identificado) => {
      response.succes(req, res, identificado, 200);
...
router.get("/reporte/:identificadoOstId", getDataReporte);
router.get("/reporteOst/:identificadoOstId", getReportePDF);
router.get("/:identificadoOstId", getById);
router.get("/documento/:identificadoOstId", getDocus);
router.put("/:identificadoOstId", put);
